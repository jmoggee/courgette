...
The full framework specification lives at
[rhyzo-architecture/spec/appendices/C-courgette-framework.md](https://github.com/loam/rhyzo-architecture/blob/main/spec/appendices/C-courgette-framework.md).
