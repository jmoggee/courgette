...
defmodule Courgette.Layout.Engine.Taffy.GapTest do
  ...
  describe "gap_column_gap_child_margins" do
    test "border_box" do
      el =
        box([width: 80, height: 100, gap_main: 10], [
  ...
  describe "gap_column_gap_determines_parent_width" do
    test "border_box" do
      el =
        box([height: 100, align_items: :stretch, gap_main: 10], [
          box(width: 10),
          box(width: 20),
          box(width: 30)
        ])
  ...
  describe "gap_column_gap_flexible" do
    test "border_box" do
      el =
        box([width: 80, height: 100, gap_main: 10, gap_cross: 20], [
  ...
  describe "gap_column_gap_flexible_undefined_parent" do
    test "border_box" do
      el =
        box([height: 100, gap_main: 10, gap_cross: 20], [
          box(flex_grow: 1, flex_basis: 0),
          box(flex_grow: 1, flex_basis: 0),
          box(flex_grow: 1, flex_basis: 0)
        ])
  ...
  describe "gap_column_gap_justify_center" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :center, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_justify_flex_end" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :flex_end, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_justify_flex_start" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :flex_start, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_justify_space_around" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :space_around, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_justify_space_between" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :space_between, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_justify_space_evenly" do
    test "border_box" do
      el =
        box([width: 100, height: 100, justify_content: :space_evenly, gap_main: 10], [
          box(width: 20),
          box(width: 20),
          box(width: 20)
        ])
  ...
  describe "gap_column_gap_row_gap_wrapping" do
    test "border_box" do
      el =
        box([width: 80, flex_wrap: :wrap, gap_main: 10, gap_cross: 20], [
  ...
  describe "gap_column_gap_wrap_align_stretch" do
    test "border_box" do
      el =
        box([width: 300, height: 300, flex_wrap: :wrap, align_content: :stretch, gap_main: 5], [
  ...
  describe "gap_row_gap_column_child_margins" do
    test "border_box" do
      el =
        box([width: 100, height: 200, flex_direction: :column, gap_main: 10], [
  ...
  describe "gap_row_gap_determines_parent_height" do
    test "border_box" do
      el =
        box([width: 100, flex_direction: :column, align_items: :stretch, gap_main: 10], [
          box(height: 10),
          box(height: 20),
          box(height: 30)
        ])
  ...
  describe "gap_row_gap_row_wrap_child_margins" do
    test "border_box" do
      el =
        box([width: 100, height: 200, flex_wrap: :wrap, gap_cross: 10], [
