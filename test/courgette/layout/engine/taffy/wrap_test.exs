defmodule Courgette.Layout.Engine.Taffy.WrapTest do
  ...
  describe "wrap_column" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, flex_wrap: :wrap], [
  ...
  describe "wrap_nodes_with_content_sizing_margin_cross" do
    test "border_box" do
      el =
        box([width: 500, height: 500, flex_direction: :column], [
  ...
  describe "wrap_row_align_items_center" do
    test "border_box" do
      el =
        box([width: 100, flex_wrap: :wrap, align_items: :center], [
  ...
  describe "wrap_row_align_items_flex_end" do
    test "border_box" do
      el =
        box([width: 100, flex_wrap: :wrap, align_items: :flex_end], [
          box(width: 30, height: 10),
          box(width: 30, height: 20),
          box(width: 30, height: 30),
          box(width: 30, height: 30)
