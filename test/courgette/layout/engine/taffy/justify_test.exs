...
defmodule Courgette.Layout.Engine.Taffy.JustifyTest do
  ...
  describe "justify_content_column_center" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, justify_content: :center], [
          box(height: 10),
          box(height: 10),
          box(height: 10)
        ])
  ...
  describe "justify_content_column_flex_start" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, justify_content: :flex_start], [
          box(height: 10),
          box(height: 10),
          box(height: 10)
        ])
  ...
  describe "justify_content_column_min_height_and_margin" do
    test "border_box" do
      el =
        box([], [
          box(
            [min_height: 50, flex_direction: :column, justify_content: :center, margin_top: 100],
            [
              box(width: 20, height: 20)
            ]
          )
  ...
  describe "justify_content_column_min_height_and_margin_bottom" do
    test "border_box" do
      el =
        box([min_height: 50, flex_direction: :column, justify_content: :center], [
  ...
  describe "justify_content_column_space_between" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, justify_content: :space_between], [
          box(height: 10),
          box(height: 10),
          box(height: 10)
        ])
  ...
  describe "justify_content_column_space_evenly" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, justify_content: :space_evenly], [
          box(height: 10),
          box(height: 10),
          box(height: 10)
        ])
  ...
  describe "justify_content_min_width_with_padding_child_width_greater_than_parent" do
    test "border_box" do
      el =
        box([width: 1000, height: 1584, flex_direction: :column, align_content: :stretch], [
  ...
  describe "justify_content_min_width_with_padding_child_width_lower_than_parent" do
    test "border_box" do
      el =
        box([width: 1080, height: 1584, flex_direction: :column, align_content: :stretch], [
          box([align_content: :stretch], [
            box(
              [
                min_width: 400,
  ...
  describe "justify_content_overflow_min_max" do
    test "border_box" do
      el =
        box(
          [min_height: 100, max_height: 110, flex_direction: :column, justify_content: :center],
          [
  ...
  describe "justify_content_row_max_width_and_margin" do
    test "border_box" do
      el =
        box([width: 100, max_width: 80, justify_content: :center], [
  ...
  describe "justify_content_row_min_width_and_margin" do
    test "border_box" do
      el =
        box([min_width: 50, justify_content: :center], [
