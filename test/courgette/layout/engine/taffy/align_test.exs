...
defmodule Courgette.Layout.Engine.Taffy.AlignTest do
  ...
  describe "align_content_center_single_line" do
    test "border_box" do
      el =
        box([width: 120, height: 100, align_content: :center], [
  ...
  describe "align_content_center_wrapped" do
    test "border_box" do
      el =
        box([width: 120, height: 100, flex_wrap: :wrap, align_content: :center], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_flex_start" do
    test "border_box" do
      el =
        box([width: 130, height: 100, flex_wrap: :wrap, align_content: :flex_start], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_not_stretch_with_align_items_stretch" do
    test "border_box" do
      el =
        box([width: 328, height: 52, flex_wrap: :wrap, align_content: :flex_start], [
  ...
  describe "align_content_space_around_single_line" do
    test "border_box" do
      el =
        box([width: 100, height: 100, align_content: :space_around], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_space_around_wrapped" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_wrap: :wrap, align_content: :space_around], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_space_between_single_line" do
    test "border_box" do
      el =
        box([width: 100, height: 100, align_content: :space_between], [
  ...
  describe "align_content_space_between_wrapped" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_wrap: :wrap, align_content: :space_between], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_space_evenly_single_line" do
    test "border_box" do
      el =
        box([width: 100, height: 100, align_content: :space_evenly], [
          box(width: 10, height: 10),
          box(width: 10, height: 10),
          box(width: 10, height: 10),
          box(width: 10, height: 10),
  ...
  describe "align_content_space_evenly_wrapped" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_wrap: :wrap, align_content: :space_evenly], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_spacearound" do
    test "border_box" do
      el =
        box([width: 140, height: 120, flex_wrap: :wrap, align_content: :space_around], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_spacebetween" do
    test "border_box" do
      el =
        box([width: 130, height: 100, flex_wrap: :wrap, align_content: :space_between], [
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
          box(width: 50, height: 10),
  ...
  describe "align_content_stretch_row" do
    test "border_box" do
      el =
        box([width: 150, height: 100, flex_wrap: :wrap, align_content: :stretch], [
          box(width: 50),
          box(width: 50),
          box(width: 50),
          box(width: 50),
  ...
  describe "align_items_center_child_with_margin_bigger_than_parent" do
    test "border_box" do
      el =
        box([width: 50, height: 50, align_items: :center, justify_content: :center], [
  ...
  describe "align_items_center_with_max_height_with_align_content_flex_start" do
    test "border_box" do
      el =
        box([width: 100, max_height: 100, align_items: :center, align_content: :flex_start], [
  ...
  describe "align_items_stretch_min_cross" do
    test "border_box" do
      el =
        box([min_width: 400, min_height: 50, flex_direction: :column], [
