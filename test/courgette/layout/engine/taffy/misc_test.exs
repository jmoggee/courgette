...
defmodule Courgette.Layout.Engine.Taffy.MiscTest do
  ...
  describe "android_news_feed" do
    test "border_box" do
      el =
        box([width: 1080, flex_direction: :column, flex_shrink: 0, align_content: :stretch], [
  ...
  describe "bevy_issue_10343_flex" do
    test "border_box" do
      el =
        box([width: 100, height: 100, flex_direction: :column, justify_content: :space_around], [
          box([], [
            box(
              [
                width: 200,
  ...
  describe "bevy_issue_7976_reduced" do
    test "border_box" do
      el =
        box([height: 200, align_content: :flex_start], [
          box(width: 40)
        ])
  ...
  describe "multiline_column_max_height" do
    test "border_box" do
      el =
        box([max_height: 200, flex_direction: :column, flex_wrap: :wrap], [
  ...
  describe "only_shrinkable_item_with_flex_basis_zero" do
    test "border_box" do
      el =
        box([width: 480, max_height: 764, flex_direction: :column], [
          box(flex_basis: 0),
  ...
  describe "rounding_flex_basis_overrides_main_size" do
    test "border_box" do
      el =
        box([width: 100, height: 113, flex_direction: :column], [
  ...
  describe "rounding_fractial_input_1" do
    test "border_box" do
      el =
        box([width: 100, height: 113.4, flex_direction: :column], [
          box(height: 20, flex_grow: 1, flex_basis: 50),
          box(height: 10, flex_grow: 1),
          box(height: 10, flex_grow: 1)
        ])
  ...
  describe "rounding_fractial_input_2" do
    test "border_box" do
      el =
        box([width: 100, height: 113.6, flex_direction: :column], [
          box(height: 20, flex_grow: 1, flex_basis: 50),
          box(height: 10, flex_grow: 1),
          box(height: 10, flex_grow: 1)
        ])
  ...
  describe "rounding_fractial_input_5" do
    test "border_box" do
      el =
        box([width: 963.333, height: 100, justify_content: :center], [
  ...
  describe "rounding_inner_node_controversy_vertical" do
    test "border_box" do
      el =
        box([height: 320, flex_direction: :column], [
  ...
  describe "rounding_total_fractial" do
    test "border_box" do
      el =
        box([width: 87.4, height: 113.4, flex_direction: :column], [
  ...
  describe "undefined_height_with_min_max" do
    test "border_box" do
      el =
        box([width: 320, min_height: 0, flex_direction: :column], [
  ...
  describe "wrapped_row_within_align_items_center" do
    test "border_box" do
      el =
        box([width: 200, height: 200, flex_direction: :column, align_items: :center], [
          box([flex_wrap: :wrap], [
  ...
  describe "wrapped_row_within_align_items_flex_end" do
    test "border_box" do
      el =
        box([width: 200, height: 200, flex_direction: :column, align_items: :flex_end], [
          box([flex_wrap: :wrap], [
            box(width: 150, height: 80),
            box(width: 80, height: 80)
          ])
  ...
  describe "wrapped_row_within_align_items_flex_start" do
    test "border_box" do
      el =
        box([width: 200, height: 200, flex_direction: :column, align_items: :flex_start], [
          box([flex_wrap: :wrap], [
            box(width: 150, height: 80),
            box(width: 80, height: 80)
          ])
